...
public class FishCakeAudio : MonoBehaviour
{
    ...
    void OnMouseDown()
    {
        bool eggComplete = GameObject.Find("Egg").GetComponent<EggAudio>().stageCompleted;
        if (eggComplete) {
    ...
    void OnCollisionEnter(Collision col)
    {
        ...
        if (!IsRamen(col.gameObject.name)) {
            ...
            Vector3 newPosition = new Vector3(10.022f, 3.103f, 1.026f);
